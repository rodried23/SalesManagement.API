...
namespace SalesManagement.Domain.Tests
{
    public class SaleTests
    {
        ...
        public void CreateSale_WithValidParameters_ShouldCreateSaleSuccessfully()
        {
            ...
            sale.TotalAmount.Should().Be(0); // Valor inicial quando não há itens
        ...
        public void AddItem_WithValidParameters_ShouldAddItemAndUpdateTotal()
        {
            ...
            addedItem.TotalPrice.Should().Be(quantity * unitPrice); // 2 * 50 = 100
        ...
        [Fact]
        public void UpdateItem_WithValidParameters_ShouldUpdateItemAndRecalculateTotal()
        {
            // Arrange
            var sale = CreateValidSale();
        ...
        [Fact]
        public void IsCanceled_ShouldReturnTrueWhenStatusIsCanceled()
        {
            // Arrange
            var sale = CreateValidSale();
